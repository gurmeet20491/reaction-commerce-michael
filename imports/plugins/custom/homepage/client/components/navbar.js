  ...
  renderBeforeHeader() {
    return (
      <div className="before-header">
        <div className="before-header-in">
          <div className="before-header-left">
      
            <div className="before-header-phone">
              <a href="tel:+18779004423">+1 (877) 900-44-23</a>
            </div>
      
            <div className="before-header-contacts">
              <a href="/contacts/">Contact Us</a>
            </div>
    
          </div>
    
          <div className="before-header-right">
            <a href="/shipping-delivery-options">Shipping &amp; Delivery</a>
